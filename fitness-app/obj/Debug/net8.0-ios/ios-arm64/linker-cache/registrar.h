...
@class MPowerKit_Navigation_PlatfromSpecific_MPowerKitNavigtaionRenderer_SwipeBackDelegate;
@class MPowerKit_Navigation_PlatfromSpecific_MPowerKitNavigtaionRenderer;
...
@interface MPowerKit_Navigation_PlatfromSpecific_MPowerKitNavigtaionRenderer_SwipeBackDelegate : NSObject<UIGestureRecognizerDelegate> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface MPowerKit_Navigation_PlatfromSpecific_MPowerKitNavigtaionRenderer : Microsoft_Maui_Controls_Handlers_Compatibility_NavigationRenderer {
}
	-(void) viewDidLoad;
	-(void) viewWillDisappear:(BOOL)p0;
	-(BOOL) navigationBar:(UINavigationBar *)p0 shouldPopItem:(UINavigationItem *)p1;
